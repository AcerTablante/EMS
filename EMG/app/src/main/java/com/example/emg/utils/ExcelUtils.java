...
public class ExcelUtils {
    ...
    private static List<Attendance> importedExcelData;
     ...
     */
    public static List<Attendance> readFromExcelWorkbook(Context context, String fileName) {
     ...
     */
    public static boolean exportDataIntoWorkbook(Context context, String fileName, List<Attendance> dataList) {
        ...
        sheet = workbook.createSheet("EMS_"+System.currentTimeMillis());
...
//        headerCellStyle.setAlignment(HorizontalAlignment.CENTER);
     ...
     */
    private static void fillDataIntoExcel(List<Attendance> dataList) {
        Row rowData;
        for (int i = 0; i < dataList.size(); i++) {
            ...
            cell.setCellValue(dataList.get(i).time);
            cell = rowData.createCell(2);
            cell.setCellValue(dataList.get(i).time_out);
...
//            }
        ...
        rowData = sheet.createRow( dataList.size()+1);
        cell = rowData.createCell(0);
        cell.setCellValue("Total Employee Present");
        cell = rowData.createCell(1);
    ...
    private static boolean storeExcelInStorage(Context context, String fileName) {
        boolean isSuccess;
        String targetpath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString();
        File file = new File(targetpath ,fileName+".xls");
     ...
     * @return importedExcelData
     */
    private static List<Attendance> retrieveExcelFromStorage(Context context, String fileName) {
